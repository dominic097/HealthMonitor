...
const scheduler_model_1 = require("./scheduler.model");
...
class Lock {
    ...
    acquire(callback) {
        ...
        return scheduler_model_1.default.findOneAndRemove(q1, (err) => {
            if (err)
                return callback(err);
            ...
            scheduler_model_1.default.create(doc, (error, lock) => {
                if (error) {
                    if (error.code === 11000) {
    ...
    release(callback) {
        ...
        return scheduler_model_1.default.findOneAndRemove(q1, (err, oldLock) => {
            if (err)
                return callback(err);
            self.lockId = null;
            self.timeAquired = null;
...
//# sourceMappingURL=scheduler.lock.js.map