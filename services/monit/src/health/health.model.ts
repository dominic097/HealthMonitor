...
serviceSchema.static('updateHealth', function (doc) {
  return this.findOneAndUpdate({ 'serviceName': doc.serviceName }, { ...doc }, { upsert: true, new: true, setDefaultsOnInsert: true }, (err, model) => {
...
export default modelName => mongoose.model(modelName, serviceSchema);
